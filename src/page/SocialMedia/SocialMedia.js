...
import SocialMediaTransitionController from './SocialMediaTransitionController';
...
export default {
  ...
  methods: {
    ...
    startSlider() {
      this.slideTimer = setInterval(() => {
        ...
        if (this.currentSlide > 7) {
          ...
          this.$refs.slide4.style.opacity = 0;
          this.$refs.slide5.style.opacity = 0;
          this.$refs.slide6.style.opacity = 0;
          TweenLite.to(this.$refs.slide7, 0.8, {opacity: 0});
        } else {
    ...
    handleAllComponentsReady() {
      this.transitionController = new SocialMediaTransitionController(this);
      this.isReady();
    },
    handleScroll(event) {
      if (event.deltaY < 0) {
